    ...
    <CommandPaletteContext.Provider value={{ open }}>
      ...
      >
        ...
        >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className={`text-sm truncate ${isActive ? "text-blue-700 font-medium" : "text-gray-900"}`}>
          ...
          {/* Footer */}
          <div className="flex items-center gap-4 px-4 py-2 border-t border-gray-100 bg-gray-50/50 text-xs text-gray-400">
