...
function RepoCard({ repo }: { repo: ProjectRepository }) {
  ...
  return (
    <div className="border border-gray-100 rounded-lg p-3.5 bg-gray-50 hover:bg-gray-100/50 transition-colors">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
          isCloned ? "bg-emerald-50 text-emerald-700 border border-emerald-200" : "bg-gray-100 text-gray-500 border border-gray-200"
        }`}>
      ...
      <div className="flex items-center gap-4 text-xs text-gray-500">
        {(repo.currentBranch || repo.defaultBranch) && (
          <span className="inline-flex items-center gap-1 font-mono bg-white px-1.5 py-0.5 rounded border border-gray-200">
              ...
              return (
                ...
                >
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-gray-900 truncate">{task.title || task.id}</p>
      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 animate-pulse space-y-3">
          ...
          {projects.map((project) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all duration-200 cursor-pointer group"
              >
                <div className="flex items-center justify-between mb-2">
