...
export const TASK_STATUS = {
  ...
  queued:      { bg: "bg-amber-50",    text: "text-amber-700",   border: "border-amber-300",  dot: "bg-amber-400",   label: "Queued" },
  ...
  verifying:   { bg: "bg-cyan-50",     text: "text-cyan-700",    border: "border-cyan-300",   dot: "bg-cyan-500",    label: "Verifying" },
  ...
  cancelled:   { bg: "bg-gray-100",    text: "text-gray-400",    border: "border-gray-200",   dot: "bg-gray-300",    label: "Cancelled" },
} as const;
...
export const PROJECT_STATUS = {
  created:   { bg: "bg-sky-50",    text: "text-sky-700",    dot: "bg-sky-500",    label: "Created" },
